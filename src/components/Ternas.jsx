  ...
  return (
    <div className="flex flex-wrap justify-center gap-4 p-4">
      {categories.map((category, index) => (
        <div data-aos="fade-up" key={index} className="box p-2 text-[0.9rem] text-ani rounded-lg text-center w-[300px] bg-yellow-500/50 border-1 border-amber-500 max-sm:w-[150px]">
          {category}
        </div>
      ))}
    </div>
